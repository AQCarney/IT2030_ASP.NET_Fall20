...
namespace QuarterlySales.Models
{
    public class SalesGridBuilder : GridBuilder
    {
        ...
        public void ClearFilterSgements() => routes.ClearFilters();
        ...
        public bool IsSortByEmployee => routes.SortField.Equals(nameof(Sales.Employee), StringComparison.InvariantCultureIgnoreCase);
